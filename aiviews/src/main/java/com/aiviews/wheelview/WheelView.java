...
public class WheelView extends View {
	...
	// 条目间距倍数
	static final float lineSpacingMultiplier = 1.1F;
	boolean isLoop;
	...
	private void initPaints() {
		...
		// 设置字体为系统默认字体，便于全局更改
		paintOuterText.setTypeface(Typeface.createFromAsset(context.getAssets(),
				"fonts/HYQingKongTiJ.ttf"));
		...
		// 设置字体为系统默认字体，便于全局更改
		paintCenterText.setTypeface(Typeface.createFromAsset(context.getAssets(),
				"fonts/HYQingKongTiJ.ttf"));
